...
<?php if ($this->_var['action'] == "vc_login"): ?>    
	<h2 class="vc_title">当前账户余额：<strong><?php echo $this->_var['info']['surplus']; ?></strong></h2>
	<form action="" method="post" name="valueForm" id="valueForm" onSubmit="return valueLogin()">
			<div class="Top">
            <dl>
             <dt>账号：</dt>
            <dd><input type="text" name="card" value="<?php echo $_SESSION['user_name']; ?>" readonly  class="inputBg" placeholder="充值账号" style="background:#eeeeee;width:90%"></dd>
            </dl>
            <dl>
            <dt>卡号：</dt>
