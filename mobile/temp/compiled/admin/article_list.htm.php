...
?>
  <tr>
    ...
    <td align="center" nowrap="true"><span>
      ...
      <!--yyy修改start-->
     <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['article_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--yyy修改end--></span>
    </td>
   </tr>
   <?php endforeach; else: ?>
