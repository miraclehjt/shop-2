...
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js,../js/transport.org.js')); ?>
...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=main">欢迎您，<?php echo $this->_var['user_name']; ?>（供货商管理中心）</a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>
