		...
		<form enctype="multipart/form-data" action="" method="post" name="theForm">
			...
			<table width="100%" id="general-table" align="center">
				<tr>
					...
					<td>
						<input type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" style="float:left;color:<?php echo $this->_var['goods_name_color']; ?>;" size="30" />
								...
								<table width="400" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_81666100_1505270603');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_81666100_1505270603']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_81666100_1505270603']['name_p'] >= "a" && $this->_var['brand_list_0_81666100_1505270603']['name_p'] <= "g"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_81666100_1505270603']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_81666100_1505270603']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_81666100_1505270603']['name']; ?>')"><?php echo $this->_var['brand_list_0_81666100_1505270603']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_81766100_1505270603');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_81766100_1505270603']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_81766100_1505270603']['name_p'] >= "h" && $this->_var['brand_list_0_81766100_1505270603']['name_p'] <= "k"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_81766100_1505270603']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_81766100_1505270603']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_81766100_1505270603']['name']; ?>')"><?php echo $this->_var['brand_list_0_81766100_1505270603']['name']; ?></a>
												</div>
											</div>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_81766100_1505270603']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_81766100_1505270603']['name_p'] >= "l" && $this->_var['brand_list_0_81766100_1505270603']['name_p'] <= "s"): ?> -->
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_81866100_1505270603');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_81866100_1505270603']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_81866100_1505270603']['name_p'] >= "t" && $this->_var['brand_list_0_81866100_1505270603']['name_p'] <= "z"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_81866100_1505270603']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_81866100_1505270603']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_81866100_1505270603']['name']; ?>')"><?php echo $this->_var['brand_list_0_81866100_1505270603']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_81966100_1505270603');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_81966100_1505270603']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_81966100_1505270603']['name_p'] >= "0" && $this->_var['brand_list_0_81966100_1505270603']['name_p'] <= "9"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_81966100_1505270603']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_81966100_1505270603']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_81966100_1505270603']['name']; ?>')"><?php echo $this->_var['brand_list_0_81966100_1505270603']['name']; ?></a>
												</div>
											</div>
...
?>
						...
						<iframe name="attr_upload" src="attr_img_upload.php?goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&goods_attr_id=<?php echo $this->_var['color_list_www_ecshop68_com']['0']['goods_attr_id']; ?>" frameborder=1 scrolling=no width="100%" height="auto" style="min-height:630px; border:1px #eee solid; margin-top:5px;"> </iframe>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
